...
import { demoteAdminSchema, requestAdminAccessSchema, reviewAdminAccessSchema } from './user.validation.js';
...
router.patch('/admins/:userId/demote', roleMiddleware(ROLES.ADMIN), validate(demoteAdminSchema), userController.demoteAdmin);
